...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="warning">
                <strong>Security Notice:</strong> If you didn't request this password reset, please ignore this email. Your organizer account remains secure.
            </div>

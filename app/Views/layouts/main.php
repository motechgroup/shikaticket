...
<head>
    ...
    $googleAnalyticsId = \App\Models\Setting::get('analytics.google.id', '');
    $gtmId = \App\Models\Setting::get('analytics.gtm.id', '');
    $facebookPixelId = \App\Models\Setting::get('analytics.facebook.pixel_id', '');
    $customHeadCode = \App\Models\Setting::get('analytics.head_code', '');
    ?>
...
$customBodyCode = \App\Models\Setting::get('analytics.body_code', '');
if ($customBodyCode): ?>
<!-- Custom Body Tracking Code -->
<?php echo $customBodyCode; ?>
<!-- End Custom Body Tracking Code -->
<?php endif; ?>

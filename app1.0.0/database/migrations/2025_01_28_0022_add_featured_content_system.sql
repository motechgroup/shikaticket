-- Add featured content system with commission tracking
-- Add featured fields to events table
ALTER TABLE events ADD COLUMN is_featured TINYINT(1) NOT NULL DEFAULT 0 AFTER is_published;
...
-- Add featured fields to travel_destinations table  
ALTER TABLE travel_destinations ADD COLUMN is_featured TINYINT(1) NOT NULL DEFAULT 0 AFTER is_published;

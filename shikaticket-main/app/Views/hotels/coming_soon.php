            ...
            <div class="text-center">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                    <div class="stat-card rounded-xl p-6 text-center hover-lift">
                        <div class="text-3xl font-bold text-green-400 mb-2"><?php echo number_format($stats['total_users']); ?>+</div>
                        <div class="text-gray-300 text-sm">Active Users</div>
                    </div>
                    <div class="stat-card rounded-xl p-6 text-center hover-lift">
                        <div class="text-3xl font-bold text-blue-400 mb-2"><?php echo number_format($stats['total_events']); ?>+</div>
                        <div class="text-gray-300 text-sm">Events Hosted</div>
                    </div>
                    <div class="stat-card rounded-xl p-6 text-center hover-lift">
                        <div class="text-3xl font-bold text-yellow-400 mb-2"><?php echo number_format($stats['total_bookings']); ?>+</div>
                        <div class="text-gray-300 text-sm">Bookings Made</div>
                    </div>
                    <div class="stat-card rounded-xl p-6 text-center hover-lift">
                        <div class="text-3xl font-bold text-purple-400 mb-2">KES <?php echo number_format($stats['total_revenue'] / 1000000, 1); ?>M+</div>
                        <div class="text-gray-300 text-sm">Revenue Generated</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="glass-effect rounded-2xl p-8 hover-lift">
                    ...
                    <p class="text-gray-300">
                        We've successfully facilitated <?php echo number_format($stats['total_bookings']); ?>+ travel bookings and <?php echo number_format($stats['total_events']); ?>+ events, 
                        generating over KES <?php echo number_format($stats['total_revenue']); ?> in revenue for our partners.
                    </p>
                </div>

                    ...
                    <div class="border border-gray-700 rounded-lg p-6">
                        ...
                        <div class="flex items-center justify-center mb-4">
                            <div class="bg-white p-4 rounded-lg">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=<?php echo urlencode($ticket['ticket_code']); ?>" 
                        ...
                        <div class="flex gap-3 flex-wrap">
                            ...
                            <button onclick="downloadTicketPDF('<?php echo $ticket['ticket_code']; ?>', '<?php echo $booking['booking_reference'] ?? $booking['id']; ?>')" class="btn btn-primary btn-sm">
                                📄 Download PDF Ticket
                            </button>
                        </div>
                    </div>

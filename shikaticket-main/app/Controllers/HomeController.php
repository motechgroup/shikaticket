...
class HomeController
{
	public function index(): void
	{
        ...
        $availableDestinations = \App\Models\TravelAgency::getAllPublishedDestinations(6, 0);
        view('home', compact('featuredEvents', 'events', 'banners', 'featuredDestinations', 'availableDestinations'));
	}
}

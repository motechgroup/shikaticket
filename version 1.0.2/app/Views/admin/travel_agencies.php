                    ...
                    <tr>
                        ...
                        <td class="p-3">
                            <div class="flex gap-2">
                                ...
                                <?php endif; ?>
                                <form method="post" action="<?php echo base_url('/admin/travel/agencies/delete'); ?>" onsubmit="return confirm('Are you sure you want to delete this travel agency? This action cannot be undone.');">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo (int)$a['id']; ?>">
